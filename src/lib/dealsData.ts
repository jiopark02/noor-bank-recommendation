...
const UK_DEALS: Deal[] = [
  ...
  },
  {
    ...
    discount_percent: 50,
    discount_text: '£4.49/month after trial',
    category: 'shopping',
    brand: 'Amazon',
  ...
  },
  {
    ...
    description: '35% off when spending £30 or more.',
    discount_percent: 35,
